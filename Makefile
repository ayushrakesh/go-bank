...
migrateup:
	migrate -path db/migrations -database "postgres://postgres:6Wi9N3ucDgJK8tXT4gdq@gopay.c7cia4imqgo7.ap-south-1.rds.amazonaws.com:5432/bank" -verbose up 

migrateup1:
	migrate -path db/migrations -database "postgres://postgres:postgres@localhost:5432/bank?sslmode=disable" -verbose up 1

migratedown:
	migrate -path db/migrations -database "postgres://postgres:6Wi9N3ucDgJK8tXT4gdq@gopay.c7cia4imqgo7.ap-south-1.rds.amazonaws.com:5432/bank" -verbose down
...
mock:
	mockgen  -package mockdb -destination db/mock/store.go github.com/ayushrakesh/gopay/db/sqlc Store
